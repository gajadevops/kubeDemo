    ...
    stage('Image Release') {
      ...
      steps {
          sh '''
            ...
            sudo docker tag $IMAGE_NAME 410602862282.dkr.ecr.us-east-2.amazonaws.com/demo-poc:$IMAGE_NAME-${BUILD_ID}
            sudo docker push 410602862282.dkr.ecr.us-east-2.amazonaws.com/demo-poc:$IMAGE_NAME-${BUILD_ID}
          '''
        }
      }
